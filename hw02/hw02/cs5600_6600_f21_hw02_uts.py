...
####################################################
# CS 5600/6600: F21: Assignment 2: Unit Tests
...
class cs5600_6600_f21_hw02_uts(unittest.TestCase):
    ...
    def test_assgn_02_ut_10(self, thresh=0.4):
        num_iters = 500
        or_wmats = train_4_layer_nn(num_iters, X1, y_or, build_2331_nn)
    ...
    def test_assgn_02_ut_11(self, thresh=0.4):
        num_iters = 700
        xor_wmats = train_3_layer_nn(num_iters, X1, y_xor, build_221_nn)
    ...
    def test_assgn_02_ut_12(self, thresh=0.4):
        ...
        print('\nTraining & Testing 1x2x2x1 NOT ANN Thresholded at {} for {} iters'.format(thresh, num_iters))
        for i in range(len(X2)):
