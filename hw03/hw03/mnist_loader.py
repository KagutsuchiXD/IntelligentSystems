...
#######################################
# module: mnist_loader.py
# description: loading MNIST data
...
def load_data_wrapper():
    ...
    corresponding to ``x``, (i.e., 0, 1, 2, 3, ..., 9).
    ...
    training_results = [one_hot_vector(y) for y in tr_d[1]]
...
def one_hot_vector(j):
    ...
    (i.e,, 0, 1, ..., 9) to the corresponding one-hot vector."""
    assert 0 <= j <= 9
    e = np.zeros((10, 1))
    e[j] = 1.0
    return e
